...
Q_CONSTINIT static const qt_meta_stringdata_CLASSPlaySceneENDCLASS_t qt_meta_stringdata_CLASSPlaySceneENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 16),  // "ChooseSceneBack2"
        QT_MOC_LITERAL(27, 0)   // ""
    },
    "PlayScene",
    "ChooseSceneBack2",
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ChooseSceneBack2(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &PlayScene::ChooseSceneBack2; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayScene::ChooseSceneBack2()
{
